...
[常用文件作用一览](/algorithmn-notes/common-file-functions-overview.html)

## 目录/文件放置建议

[目录放置建议](/algorithmn-notes/directory-structure-suggestions.html)

## 每个文件的示范模板

[示范模板](/algorithmn-notes/demo-template.html)

## Rule

[CursorRule](/algorithmn-notes/cursorrule.html)

## 设定 Cursor 对文件的读写权限

[设定 Cursor 对文件的读写权限](/algorithmn-notes/set-cursor-file-permissions.html)

## MCP 相关

[CursorMCP](/algorithmn-notes/cursormcp.html)
